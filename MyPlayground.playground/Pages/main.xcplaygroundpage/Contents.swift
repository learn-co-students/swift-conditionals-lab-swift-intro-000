...
func bankTransfer(bankaccounta: Int, bankaccountb: Int){
    if (bankaccountb - 10) > 0 {
        bankaccounta + 10
        bankaccountb - 10
    }
    print ("The value of your bank account is \(bankaccounta) and the value of the second account is \(bankaccountb)")
}

bankTransfer(bankaccounta: GeoBank, bankaccountb: SantBank)
