...
func isForceWith(string: String) -> Bool {
    ...
    if ((string != "Luke") && (string != "Leia") && (string != "Anakin") && (string != "Obi Wan") && (string != "Yoda") && (string != "Vader")) {
...
*/
func accounts(mine: inout Double, yours: inout Double) {
...
accounts(mine: &mine, yours: &yours)
