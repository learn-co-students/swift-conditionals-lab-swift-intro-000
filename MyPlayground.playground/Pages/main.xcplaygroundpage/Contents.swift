...
*/
func isGreater(_ x1: Int, _ x2: Int) -> Bool {
    if x1 > x2 {
        return true
    } else {
        return false
...
*/
var bankAmmount = 35
var personalAmmount = 25
func bankAccount(_ personal: inout Int, _ bank: inout Int) {
    if bank >= 10 {
        personal += 10
        bank -= 10
    }
}
bankAccount(&personalAmmount, &bankAmmount)
print(personalAmmount)
print(bankAmmount)
bankAccount(&personalAmmount, &bankAmmount)
print(personalAmmount)
print(bankAmmount)
