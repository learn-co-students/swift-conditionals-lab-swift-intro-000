...
*/
// write your code here
func bankFunc(myAccountBalance: Double, otherAccountBalance: Double){
    var myAccountBalance = myAccountBalance
    var otherAccountBalance = otherAccountBalance
    
    if otherAccountBalance - 10 >= 0 {
        myAccountBalance = myAccountBalance + 10
        otherAccountBalance = otherAccountBalance - 10
    }
}
