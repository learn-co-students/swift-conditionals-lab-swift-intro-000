...
func isForceWith(jedi: String) -> Bool {
  if (jedi == "Luke") || (jedi == "Leia") || (jedi == "Anakin") || (jedi == "Obi Wan") || (jedi == "Yoda") || (jedi == "Vader") {
      return true
  } else {
    return false
  }
...
isForceWith(jedi: "Vader")
isForceWith(jedi: "Obi Wan")
isForceWith(jedi: "Bryan")
