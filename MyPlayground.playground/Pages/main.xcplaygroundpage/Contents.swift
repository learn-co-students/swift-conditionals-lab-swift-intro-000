...
*/
func isForceWith(x: String) -> Bool{
    if x == "Luke" || x == "Leia" || x == "Anakin" || x == "Obi Wan" || x == "Yoda" || x == "Vader"
    {
        print("It works!")
        return true
    }
...
*/
func diffBank(myBank: Double, otherBank: Double){

    
    if otherBank - Double(10) >= 0{
        myBank + 10
        otherBank - 10
    }
    else{
        print("Unable to perform transfer")
    }
}
