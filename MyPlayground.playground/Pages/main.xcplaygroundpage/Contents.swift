...
*/
func isForthWith(name: String) -> Bool {
    if ( name == "Luke" ||
         name == "Leia" ||
         name == "Anakin" ||
         name == "Obi Wan" ||
...
*/
func manageMoney(checkingAccountBalance: Double, savingsAccountBalance: Double) {
    if savingsAccountBalance >= 10.0 {
        savingsAccountBalance - 10
        checkingAccountBalance + 10
    }
}
