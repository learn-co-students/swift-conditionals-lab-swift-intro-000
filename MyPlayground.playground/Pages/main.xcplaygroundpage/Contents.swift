...
*/
print(Double(y) > x && Double(a)/Double(b) > 9)
/*: Question 9
...
func isForceWith(_ name: String) -> Bool {
    switch name {
        case "Luke": fallthrough
        case "Leia": fallthrough
        case "Anakin": fallthrough
        case "Obi-Wan": fallthrough
...
*/
func transferTenDollars(mut myAcctBal: inout Double, otherAcctBal: inout Double) {
    if (otherAcctBal >= 10.0) {
        otherAcctBal -= 10.0
        myAcctBal += 10.0
    }
}
