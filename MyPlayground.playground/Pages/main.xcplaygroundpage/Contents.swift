...
*/
func takeOut10Bucks(personalAccount: Double, businessAccount: Double) {
    if  businessAccount >= 10.0 {
        personalAccount + 10.0
        businessAccount - 10.0
    } else {
        print("Not enough money chump!")
    }
}

takeOut10Bucks(personalAccount: 100.00, businessAccount: 20.00)
