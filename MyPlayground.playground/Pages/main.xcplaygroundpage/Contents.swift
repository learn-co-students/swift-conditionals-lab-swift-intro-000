...
*/
// write your code here
if Double(y) >= x && Double(a)/Double(b) > 9.0 {
    print(true)
}
...
*/
// write your code here
func transfer(to yourAccount: Double, from otherAccount: Double) -> (Double, Double) {
    var yourNewAccount: Double = yourAccount
    var otherNewAccount: Double = otherAccount
    if otherAccount >= 10 {
        yourNewAccount = yourAccount + 10
        otherNewAccount = otherAccount - 10
    }
    return (yourNewAccount, otherNewAccount)
}
print(transfer(to: 10.0, from: 15))
print(transfer(to: 200, from: 5))
