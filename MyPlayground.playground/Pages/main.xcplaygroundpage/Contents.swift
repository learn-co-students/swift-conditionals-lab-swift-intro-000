...
func isGreater(o: Int, oo: Int) -> Bool {
    return o > oo
}
...
func isForceWith(people: String) -> Bool {
...
bankAccount(myAccount: 30, frinedAccount: 30)
