...
func isGreater(a:Double, b:Double)->Bool{
    if a>b{
        return true
    }
    else{
...
func isForceWith(a:String)->Bool{
    let jedi = ["Luke","Leia","Anakin","Obi Wan", "Yoda"]
    let sith = ["Darth Vader","Darth Maul", "Darth Sidious"]
    if (jedi.contains(a))||(sith.contains(a)){
        return true
    }
    else{
        return false
...
isForceWith(a: "Raphael")
isForceWith(a: "Darth Sidious")
...
*/
// write your code here
func bankAccount(myacc:Int, otheracc:Int){
    if (otheracc>=10){
        myacc + 10
        otheracc - 10
    }
