...
*/
var checkingAccount = 100
var savingsAccount = 11

func moneyTransfer(accountOne: Int, accountTwo: Int) {
    
    if accountTwo < 10 {
        print("Savings account will go negative.  Can't process transfer...")
    } else {
        checkingAccount += 10
        savingsAccount -= 10
        
        print("You have moved $10.00 from your Savings account to your Checking account.  Your Checking account balance is now $\(checkingAccount).00.  Your Savings account balance is now $\(savingsAccount).00")
    }
}

moneyTransfer(accountOne: checkingAccount, accountTwo: savingsAccount)
