...
*/
func myFunction(acctOne: Double, acctTwo: Double)->String{
    var acctOne = acctOne
    var acctTwo = acctTwo
    if acctOne < 0 && acctTwo >= 10{
        acctOne += 10
        acctTwo -= 10
        return "Account 1: $\(acctOne); Account 2: $\(acctTwo)"
    }
    if acctTwo < 0 && acctOne >= 10{
        acctOne -= 10
        acctTwo += 10
        return "Account 1: $\(acctOne); Account 2: $\(acctTwo)"
    }
...
myFunction(acctOne: -29, acctTwo: 20)
