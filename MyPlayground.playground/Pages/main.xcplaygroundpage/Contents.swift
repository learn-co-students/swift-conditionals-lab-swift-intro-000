...
isGreater(numberOne: 10, numberTwo: 5)
isGreater(numberOne: 20, numberTwo: 90)
/*: Question 10
...
*/
func transferTenDollars(myBankAccount: Int, otherBankAccount: Int) {
    if otherBankAccount >= 10 {
        myBankAccount + 10
        otherBankAccount + 10
    }
}

transferTenDollars(myBankAccount: 10, otherBankAccount: 50)
/*:
