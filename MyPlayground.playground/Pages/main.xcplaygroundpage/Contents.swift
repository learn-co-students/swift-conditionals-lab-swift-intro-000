...
*/
func isGreaterThan(one: Int, two: Int) -> Bool {
    return true
}
...
isGreaterThan(one: three, two: four)
...
*/
func addTenDollars(myAccount: Int, otherAccount: Int) {
    if otherAccount >= 10 {
    myAccount + 10
    otherAccount - 10
    }
...
addTenDollars(myAccount: 1000, otherAccount: 1000)
