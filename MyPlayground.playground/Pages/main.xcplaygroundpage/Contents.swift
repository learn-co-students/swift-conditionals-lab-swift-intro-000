...
let lessThanresult = (y * b) <= a
print(lessThanresult)

/*: Question 4
### 4. Print the inverse of a greater than or equal to b
*/

let inverseTotal = (a >= b)
print(!inverseTotal)
...
*/
func bankAcc(myBankAccount: Int, otherAccount: Int){
    if otherAccount - 10 >= 0 {
       let myTotal = myBankAccount + 10
       let otherTotal = otherAccount - 10
        print(myTotal, otherTotal)
    }
}

bankAcc(myBankAccount: 20, otherAccount: 10)
