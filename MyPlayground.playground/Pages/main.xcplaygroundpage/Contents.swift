...
func isForceWith(name: String) -> Bool {
    if name == "Luke" || name == "Leia" || name == "Anakin" || name == "Obi-Wan" || name == "Yoda" || name == "Darth Vader" {
        return true
    } else {
        return false
    }
}
isForceWith(name: "Rey")
// refactor with case switch statements or a ternary with an array
/*: Question 11
