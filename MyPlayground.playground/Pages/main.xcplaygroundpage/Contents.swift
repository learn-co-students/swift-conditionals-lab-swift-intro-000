...
*/
func transfer(myAccount: inout Double, yourAccount: inout Double) {
    if (yourAccount - 10.0) > 0.0 {
        myAccount = myAccount + 10.0
        yourAccount = yourAccount - 10.0
    }
}

var myBalance = 0.0
var yourBalance = 25.0
transfer(myAccount: &myBalance, yourAccount: &yourBalance)
