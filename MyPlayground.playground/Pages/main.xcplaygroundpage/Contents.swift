...
func isGreaterLearnCo(a:Int, b:Int) -> Bool {
    if a > b {
        return true
    } else {
        return false
...
isForceWith(arg: "Luke")
isForceWith(arg: "Nick")

func isForceWithLearnCo(name:String) -> Bool {
    if name == "Luke" {
        return true
...
func bankCalculator(myAcct:Int, theirAcct:Int) -> Int {
    if theirAcct >= 10 {
        myAcct + 10
        theirAcct - 10
    }
...
bankCalculator(myAcct: 10, theirAcct: 20)

func transferTenDollarsLearnCo(myAccount: Int, otherAccount: Int) {
    if otherAccount >= 10 {
        myAccount + 10
        otherAccount - 10
    }
