...
isGreater(num1: 10, num2: 5)
isGreater(num1: 7, num2: 14)
...
*/
func bankTransfer(myBank: Int, otherBank: Int) {
    if(otherBank >= 10) {
       let his = otherBank - 10
       let mine = myBank + 10
       print("Your account now has \(mine)$, the other account now has \(his)$")
    } else {
       print("Sorry, it's too empty :(")
    }
}

bankTransfer(myBank: 100, otherBank: 100)
bankTransfer(myBank: 100, otherBank: 9)
