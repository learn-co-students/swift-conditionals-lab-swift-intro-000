...
*/
var forceArray = ["Luke", "Leia", "Anakin", "Obi Wan", "Yoda", "Vader"]

func isForceWith(arg1:String)->Bool{
    if forceArray.contains(arg1){
        return true
    } else {
        return false
    }
}
isForceWith(arg1: "Zach")
...
*/
func bankAccount(myBank:Int, yourBank:Int){
    if yourBank >= 10 {
    yourBank - 10
        myBank + 10
    }
