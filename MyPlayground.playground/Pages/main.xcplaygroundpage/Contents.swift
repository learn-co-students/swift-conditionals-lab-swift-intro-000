...
*/
// write your code here
func isForceWith(state: String) -> Bool{
    if (state == "Luke"){
        return true
    ...
    }else if state == "Anakin"{
                return true
    
    }else if state == "Obi Wan"{
                    return true
...
bankAccount(mine: 3440, other: 330)
