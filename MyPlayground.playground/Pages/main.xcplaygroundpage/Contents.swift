...
*/
func isGreater(_ one: Int, _ two: Int) {
    if one > two {
        print("true")
    } else {
        print("false")
...
*/
func isForceWith(_ strang: String) {
    if strang == "Luke" {
        print("true")
    } else if strang == "Leia" {
        print("true")
    } else if strang == "Anakin" {
        print("true")
    } else if strang == "Obi Wan" {
        print("true")
    } else if strang == "Yoda" {
        print("true")
    } else if strang == "Vader" {
        print("true")
    } else {
        print("false")
    }
...
*/
func transfers(_ myAccount: Int, _ yourAccount: Int) {
    if yourAccount >= 10 {
        myAccount + 10
        yourAccount - 10
    }
