...
*/
// write your code here
func bankAccounts(b1:Double, b2:Double){
    let tempb2 = b2 - 10
    if(tempb2 > 0){
       let b1f = b1 + 10
        print(b1f)
...
//Note: in Swift 3 the params functions are constants, not like in Swift 2.2 they were vars
