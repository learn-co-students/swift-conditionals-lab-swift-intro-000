...
func bankAccount(deposit: Int, withdrawal: Int) -> Int {
    var myAccount = 0
    var yourAccount = 100
    if (myAccount <= 0) {
        myAccount += deposit
        return myAccount
    } else if (yourAccount > 10){
        yourAccount -= withdrawal;
        return yourAccount
    }
}

bankAccount(deposit: 10, withdrawal: 10)
