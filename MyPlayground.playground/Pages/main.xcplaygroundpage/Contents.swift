...
func isGreater(n:Int, z:Int) -> Bool {
    if n > z {
        return true
    } else {
        return false
...
func accounts(myAccount:Int, otherAccount:Int) -> String {
    if otherAccount - 10 >= 0 {
        var myAccountUpdate = myAccount + 10
        var otherAccountUpdate = otherAccount - 10
        
        return "Your account balance is \(myAccountUpdate) and the balance in the other account is \(otherAccountUpdate)."
...
accounts(myAccount: 100, otherAccount: 35)
