...
*/
func lastOne(mine:Double, other: Double){
    if mine >= other && other >= 0{
        var newOther = other - 10
        var newMine = mine + 10
        
        if newOther <= 0{
            print("Can't add founds from the other account")
        }else{
        print(newMine, newOther)
        }
...
lastOne(mine: 35.67, other: 19.78)
