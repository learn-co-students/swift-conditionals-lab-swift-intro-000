...
*/
func accounts(theirs : Int, mine : Int) {
    if (theirs >= 10){
        var theirAccount = theirs - 10
        var myAccount = mine + 10
        print ("My account is at $\(myAccount), their account is at $\(theirAccount)")
    }
}
accounts(theirs: 11, mine: 20)
