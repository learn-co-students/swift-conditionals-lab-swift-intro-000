...
*/
// write your code here
func bankAccount (mine: Double, them: Double) -> String {
    var x = mine
    if (them - Double(10) >= 0) {
        x = x + Double(10)
        return "You have $\(x) in your account!"
    }
    else {
        return "You have $\(x) in your account!"
    }
...
print(bankAccount(mine: 459.22, them: 23.84))
print(bankAccount(mine: 459.22, them: 2.44))
