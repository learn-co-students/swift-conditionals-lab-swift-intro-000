...
func bankAccounts (mine: Int, someones: Int) -> (Int, Int, String) {
    if someones - 10 >= 0 {
        return (mine + 10, someones - 10, "Transfer success!")
    }
    return (mine, someones, "There's not enough money for the exchange")
}

bankAccounts(mine: 20, someones: 40)
