...
*/
func isGreate (a: Int, b: Int) -> Bool {
    if a > b {
        return true
    }
    else {
...
print(isGreate(a: 5, b: 3))
print(isGreate(a: 3, b: 6))
...
print(isForceWith(name: "Ramunas"))
print(isForceWith(name: "Vader"))
...
*/
func transfereFunds (myAccount : Int, otherAccount: Int){
    
    if otherAccount < 10 {
        print("Insuficient balance")
    }
    else {
        let myAccountBalance = myAccount + 10
        let otherAccountBalance = otherAccount - 10
        print("Your account balance is \(myAccountBalance)")
        print("Other account balance is \(otherAccountBalance)")
    }
}
