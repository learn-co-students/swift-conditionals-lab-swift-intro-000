...
*/
// write your code here
func isForceWith(forceName: String) -> Bool {
    if forceName == "Luke" {
        return true
        
    } else if forceName == "Leia" {
        return true
        
    } else if forceName == "Anakin" {
        return true
        
    } else if forceName == "Obi Wan" {
        return true
        
    } else if forceName == "Yoda" {
        return true
        
    } else if forceName == "Vader" {
        return true
