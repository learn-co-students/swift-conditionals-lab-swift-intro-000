...
*/
func isGreater(value1: Int, value2: Int) {
    if value1 > value2 {
        return
    }
    else {
...
*/
func isForceWith(char:String) -> Bool {
...
let forceList = ["Luke", "Leia", "Anakin", "Obi Wan", "Yoda", "Vader"]

isForceWith(char:"Luke")
