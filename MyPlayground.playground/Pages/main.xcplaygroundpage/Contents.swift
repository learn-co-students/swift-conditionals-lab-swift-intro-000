...
*/
    ...
    func isGreater (_ firstArg : Int, _ secondArg: Int) -> Bool {
...
*/
    ...
    func isForceWith(_ input: String) -> Bool {
        
        if input == "Luke" {
            return(true)
        }  else if input == "Leia" {
            return(true)
        } else if input == "Anakin" {
            return(true)
        } else if input == "Obi Wan" {
            return(true)
        } else if input == "Yoda" {
            return(true)
        } else if input == "Vader" {
...
*/
    ...
    func bankTransfer(_ myAcc: Int,_ otherAcc: Int) {
        ...
        if otherAcc >= 10 {
            myAcc += 10
            otherAcc -= 10
            print("My new balance is \(myAcc)")
            print("Remaining balance in other account is \(otherAcc) ")
        
        } else {
            print("Transfer not possible, not enough money")
        }
