...
isGreater(number1: 5, number2: 10)
isGreater(number1: 10, number2: 5)
...
func bankAccount(myAccount : Double, yourAccount: Double) {
...
bankAccount(myAccount: 50, yourAccount: 11)
bankAccount(myAccount: 40, yourAccount: 9)
