...
isGreater(firstNumber: 4, secondNumber: 2)
...
*/
func accounting(_ myBankAccount: Double,_  franksBankAccount: Double) {
    var mine = myBankAccount
    var franks = franksBankAccount
    if franks >= 10.00 {
        mine = mine + 10.00
        franks = franks - 10.00
        print("My bank account has \(mine) dollars")
        print("Franks bank account has \(franks) dollars")
    } else {
        print("Not enough in Franks account")
    }
}
