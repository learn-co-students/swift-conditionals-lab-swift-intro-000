...
let name10 = "Leia"
if isForceWith(name: name10.lowercased()){
    print("The force is strong with \(name10).")
} else{
    print("The force looks with pity upon \(name10)'s soul.")
}
...
*/
func bankBalance(myAcct: Double, yourAcct: Double){
    if yourAcct >= 10.0 {
        let myNewBalance = myAcct + 10.0
        let yourNewBalance = yourAcct - 10.0
        print("My new account balance is $\(myNewBalance).")
        print("Your new account balance is $\(yourNewBalance)! In your face!")
    } else {
        print("You poor soul, I won't take money from you today")
    }
}

bankBalance(myAcct: 10000, yourAcct: 10)
