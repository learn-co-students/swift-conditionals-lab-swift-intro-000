...
func isGreater(_ first:Int, _ second:Int) {
    if first > second {
        print(true)
    } else {
        print(false)
...
func takeMyMoney(_ myAcct: Double, _ otherAcct: Double) {
    if otherAcct - 10 >= 0 {
        otherAcct - 10
        myAcct + 10
    }
