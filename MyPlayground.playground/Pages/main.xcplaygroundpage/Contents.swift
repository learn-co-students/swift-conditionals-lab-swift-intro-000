...
func isForceWith(name: String) -> Bool {
    if (name == "Luke") || (name == "Leia" ) || (name == "Anakin") || (name == "Obi Wan") || (name == "Yoda") || (name == "Vader") { return true} else {
        return false
    }
}

isForceWith(name: "Luke")
isForceWith(name: "Trung")
...
*/
func bankProblem(_myAcct: Int, _otherAcct:Int){
    if _otherAcct >= 10 {
        _myAcct + 10
        _otherAcct - 10
    }
