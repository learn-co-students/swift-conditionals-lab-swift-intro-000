...
func isForceWith(withMe name: String)->Bool{
    var peopleWithTheForce = ["Luke", "Leia", "Anakin", "Obi Wan", "Yoda", "Vader"]
    
    for people in peopleWithTheForce{
        if name == people{
            return true
        }
    }
...
func transfer(tranferTo otherBank:Double, transferFrom myBank:Double ){
    if otherBank > 10 {
        otherBank - 10
        myBank + 10
        print("You transfered $10")
    }
