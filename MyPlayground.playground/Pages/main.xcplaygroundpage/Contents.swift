...
*/
func isGreater(firstNumber: Int, SecondNumber: Int) {
...
isGreater(firstNumber: 3, SecondNumber: 2)
...
*/
func transfer(bal1: Int, bal2: Int) {
    if bal2 - 10 > 0 {
    var newbal1 = bal1 + 10
    var newbal2 = bal2 - 10
    print ("The new balance of acc 1 is \(newbal1)")
    print ("The new balance of acc 2 is \(newbal2)")
    } else
    { print ("Transfer Not Possible")}
    
}

transfer (bal1: 100, bal2: 100)
transfer(bal1: 10, bal2: 5)
