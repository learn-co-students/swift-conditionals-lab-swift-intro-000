...
*/
// write your code here
func isGreater(i: Int, j: Int) -> Bool {
    if i > j {
        return true;
    } else {
        return false;
...
*/
// write your code here
func isForceWith(str: String) -> Bool {
    if str == "Luke" || str == "Leia" || str == "Anakin" || str == "Obi Wan" || str == "Yoda" || str == "Vader" {
        return true;
    } else {
        return false;
    }
...
*/
// write your code here
func withdrawFunds(bankA: Double, bankB: Double) {
    var myBank = bankA
    var yourBank = bankB
    if yourBank - 10.0 >= 0.0 {
        myBank = bankA + 10.0
        yourBank = bankB - 10.0
    }
}
