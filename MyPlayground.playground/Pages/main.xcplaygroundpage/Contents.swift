...
*/
func isForceWith(_ string: String) -> Bool {
    return string == "Luke" || string == "Leia" || string == "Anakin" || string == "Obi Wan" || string == "Yoda" || string == "Vader"
}
...
*/
func take10Bucks(myAccount: inout Float, yourAccount: inout Float) {
    if( yourAccount - 10.0 > 0 ) {
        yourAccount -= 10.0
        myAccount += 10.0
    }
}
