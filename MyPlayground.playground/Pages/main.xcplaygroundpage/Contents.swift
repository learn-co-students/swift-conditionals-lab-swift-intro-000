...
func isForceWith (name: String) -> Bool {
    if name == "Luke" && name == "Leila" && name == "Anakin" && name == "Obi Wan" && name == "Yoda" && name == "Vader" {
        return true
    } else {
        return false
    }
...
*/
func bankDetails (bankAccount1: Double,bankAccount2: Double) {
    if bankAccount2 >= 10 {
        bankAccount1 + 10
        bankAccount2 - 10
    }
...
bankDetails(bankAccount1: 10, bankAccount2: 30)
