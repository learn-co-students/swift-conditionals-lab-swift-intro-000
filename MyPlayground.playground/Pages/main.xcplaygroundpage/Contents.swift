...
*/
if Double(y) > x && Double(a / b) > Double(9) {
    print("true")
}
...
*/
func isForceWith (_ a: String) -> Bool {
    if a == "Luke" {
        return true
    }
    else if a == "Leia" {
...
*/
func bankTransfer(myAccount: Double, otherAccount: Double, transfer: Double) {
    if transfer > otherAccount {
        print("Not enough funds!")
    }
    else {
        print ("myAccount = \(myAccount + transfer)")
        print ("therAccount = \(otherAccount - transfer)")
    }
}


bankTransfer(myAccount: 1000, otherAccount: 1, transfer: 10)
bankTransfer(myAccount: 1000, otherAccount: 1000000, transfer: 10)
