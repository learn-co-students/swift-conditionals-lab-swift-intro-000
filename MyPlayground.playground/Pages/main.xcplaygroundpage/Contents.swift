...
*/
func isGreater(int1: Int, int2: Int) {
    if int1 > int2 {
        print("True")
    } else {
        print("False")
...
*/
func isForceWith(Strong: String) {
    if Strong == "Luke" || Strong == "Leia" || Strong == "Anakin" || Strong == "Obi Wan" || Strong == "Yoda" || Strong == "Vader" {
        print("True")
    } else {
        print("False")
    }
...
func bank(account1: Int, account2: Int) {
    if account2 >= 0 {
        account1 + 10
        account2 - 10
    }
