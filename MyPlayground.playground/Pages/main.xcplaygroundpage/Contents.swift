...
*/
func isForceWith(characterName:String) -> Bool {
  if characterName == "Luke"  {
     return true
  }else if characterName == "Leia"  {
     return true
  }else if characterName == "Anakin"  {
     return true
  }else if characterName == "Obi Wan"  {
     return true
  }else if characterName == "Yoda"  {
     return true
  }else if characterName == "Vader"  {
     return true
  }else  {
     return false
  }
...
*/
func bankTransferFunds(myBankAccount: Int, anotherBankAccount: Int) {

  if anotherBankAccount >= 10  {
     myBankAccount + 10
     anotherBankAccount - 10
  }
}
