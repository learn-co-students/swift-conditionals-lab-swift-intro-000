...
*/
func isForceWith(argument:String)->Bool{
    if(argument=="Luke" || argument=="Leia" || argument=="Anakin" || argument=="Obi Wan" || argument=="Yoda" || argument=="Vader"){
    return true
    }
    else{
    return false
