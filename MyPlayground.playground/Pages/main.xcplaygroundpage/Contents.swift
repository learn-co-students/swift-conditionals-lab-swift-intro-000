...
func isForceWith(peopleWithForce: String) -> Bool{
    
    if peopleWithForce == "Leisa"{
        return true
    }else if peopleWithForce == "Luke"{
        return true
    }else if peopleWithForce == "Anakin"{
        return true
    }else if peopleWithForce == "Obi Wan"{
        return true
    }else if peopleWithForce == "Yoda"{
        return true
    }else if peopleWithForce == "Vader"{
        return true
    }else{
        return false
    }
...
bankAccount(mine: 10, yours: 10)
bankAccount(mine: 10, yours: 5)
