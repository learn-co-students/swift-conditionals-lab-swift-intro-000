...
*/
func isForceWith (isForceStrong: String) -> Bool {
    if (isForceStrong == "Luke" || isForceStrong == "Leia" || isForceStrong == "Anakin"
        || isForceStrong == "Obi Wan" || isForceStrong == "Yoda" || isForceStrong == "Vader" ) {
        return true
    } else {
        return false
    }
...
*/
func transferMoney(_: Double, _: Double) {
    if (momsAcct >= 10){
        myAcct += 10
        momsAcct -= 10
    }
...
transferMoney(_: myAcct, _: momsAcct)
