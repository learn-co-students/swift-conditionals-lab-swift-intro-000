...
*/
func isGreater(num1 a: Int,num2 b: Int) -> Bool {
    if a > b {
      return true
    } else {
      return false
...
isGreater(num1: a, num2: y)


/*: Question 10
### 10. Write a function "isForceWith" that takes a String argument and returns true if the argument is the name of someone with whom the force is strong, and otherwise returns false. People who have the force are Luke, Leia, Anakin, Obi Wan, Yoda, Vader.
*/
func isForceWith(name a: String) -> Bool {
    if a == "Luke" {
        return true
...
isForceWith(name: "Dom")


/*: Question 11
### 11. Create a function where the two arguments represent different bank account (one of those bank accounts is yours). What type should these arguments be if we are to then perform some math operations on them? Setup a conditional that will add 10 to your funds and minus 10 from the other funds (bank account) if the other account won't go negative if we were to take 10 dollars from it.
*/
func withdrawTenBucks(personalBankaccount a: Double, businessBankaccount b: Double) {
...
withdrawTenBucks(personalBankaccount: 24.00, businessBankaccount: 5.0)
