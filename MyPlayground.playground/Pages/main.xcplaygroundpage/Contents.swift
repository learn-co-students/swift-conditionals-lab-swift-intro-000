...
print(isGreater(first: 10, second: 20))
...
*/
// write your code here
func transfer10Dollar(myAccount: Int, otherAccount: Int) {
    if otherAccount >= 10 {
        print(otherAccount)
        print(myAccount)
        
        let myAccountNew = myAccount + 10
        let otherAccountNew = otherAccount - 10
        
        print(myAccountNew)
        print(otherAccountNew)
    }
...
transfer10Dollar(myAccount: 100, otherAccount: 90)
